...
public interface UserDao {
	...
	List<User> list(@Param("keyword") String keyword, @Param("active") Boolean active, @Param("authc") Boolean authc, @Param("unitIds") Long[] unitIds, @Param("roleType") RoleTypeEnum[] roleType);

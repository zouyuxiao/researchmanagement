...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<User> list(String keyword, Boolean active, Boolean authc, Long[] unitIds, RoleTypeEnum[] roleType) {
        return userDAO.list(keyword, active, authc, unitIds, roleType);
    }

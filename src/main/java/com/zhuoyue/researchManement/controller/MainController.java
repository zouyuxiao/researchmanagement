...
public class MainController extends BaseController {
    ...
    @GetMapping(value = {"/notice/list",
            ...
            "/subject/list/", "/subject/list/school", "/subject/list/area",
            "/subject/list/city", "/subject/expert/list/check", "/subject/expert/list/recheck", "/subject/expert/list/log",
            "/subject/approval/list", "/subject/approval/list/mine", "/subject/approval/list/host", "/subject/approval/list/city",
            ...
            "/record/list", "/record/list/city",
            "/user/list", "/user/list/check", "/user/update/info", "/user/update/host", "/user/update/expert",})
    ...
    public String subjectCheckAppoint(@PathVariable Long subject_id, HttpServletRequest request, Model model) {
        model.addAttribute("subjectId", subject_id);
        model.addAttribute("approval", subjectApprovalService.selectBySubjectId(subject_id));
        model.addAttribute("experts", userService.list(null, null, null, null, new RoleTypeEnum[]{RoleTypeEnum.EXPERT}));
    ...
    public String userInfo(@PathVariable Long id, HttpServletRequest request, Model model) {
        model.addAttribute("user", userService.selectById(id));
        return getPageURI("/user/info", request, model);
    }
